...
export default () => {
  ...
  const bgColor = getHexColorByAlpha(resumeData.content.config.themeColor, 0.06);

  return (
    <div
      style={{
        backgroundColor: bgColor,
        borderRadius: resumeData.content.avatar.radius,
      }}
      className={'flex justify-between rounded-b'}
    >
